...
The feature is enabled in production with a 30-review-per-run cap. The normal sourcing path, credit reservation, Hyperbrowser usage, and Claude generation are unchanged beyond that bounded review step. Candidate profile data sent to Jev is limited to target roles, location, and location preference; contact details and resume text are not sent.
